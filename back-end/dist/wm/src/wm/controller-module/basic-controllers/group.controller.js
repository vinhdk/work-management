...
class GroupController {
    constructor(sequelize) {
        this.useCreate = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            const data = new view_models_module_1.GroupCM(req.body).getData(username, username);
        ...
        this.useUpdate = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const username = JSON.parse(req.headers.extra).UserName;
            const data = new view_models_module_1.GroupUM(Object.assign({}, req.body)).getData(username);
        ...
        this.useGetAll = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            yield this.service.useGetAll(Object.assign({}, req.query), [this.userRepository]).then((list) => {
                const arr = list.map((model) => new view_models_module_1.GroupVM(Object.assign({}, model.get())).getData());
                return res.status(200).json(arr);
            }).catch((err) => res.status(400).json({ message: "Có lỗi xảy ra" }));
        });
        this.useGetById = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            yield this.service.useGetOne({ Id: req.params.id }, [this.userRepository])
                .then((model) => {
                return model != null ? res.status(200).json(new view_models_module_1.GroupVM(Object.assign({}, model.get())).getData())
                    : res.status(404).json({ message: "Không tìm thấy " + req.params.id });
            }).catch((err) => res.status(400).json({ message: "Có lỗi xảy ra" }));
        });
        this.service = new wm_service_1.BaseService(wm_model_1.Group, sequelize);
