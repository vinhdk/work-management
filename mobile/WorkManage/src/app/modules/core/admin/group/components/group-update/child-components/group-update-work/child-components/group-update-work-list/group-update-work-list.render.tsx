...
import { useStyles } from "./group-update-work-list.styles";
import { IGroupUpdateWorkListProps } from "./group-update-work-list.component";

export interface IRenderGroupUpdateWorkListProps extends IGroupUpdateWorkListProps {
...
export const RenderGroupUpdateWorkListComponent = (props: IRenderGroupUpdateWorkListProps) => (
    <View style={useStyles().container}>
        <Item regular style={{ paddingHorizontal: 10, width: "100%" }}>
            ...
            <TouchableOpacity disabled={props.extra.users.filter(e => e.Works.length === 0).length === 0} onPress={() => props.useClickCreate()}>
                <Icon style={{ color: props.extra.users.filter(e => e.Works.length === 0).length === 0 ? "grey" : "green" }} name="plus-square" type="FontAwesome5" />
            </TouchableOpacity>
        </Item>
        <Item regular style={{ paddingHorizontal: 10, width: "100%" }}>
