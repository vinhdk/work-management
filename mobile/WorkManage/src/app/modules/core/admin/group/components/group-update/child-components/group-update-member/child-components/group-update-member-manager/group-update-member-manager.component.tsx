...
import { RenderGroupUpdateMemberManagerComponent } from "./group-update-member-manager.render";
import { UserVM } from "src/app/view-models";
import { group } from "console";
import { Alert } from "react-native";
import { useUserAction } from "src/app/actions";

export interface IGroupUpdateMemberManagerProps extends IGroupUpdateMemberProps {
    Id: string;
    accounts: UserVM[];
    data: UserVM[];
    useChange: () => void;
...
export const GroupUpdateMemberManagerComponent = (props: IGroupUpdateMemberManagerProps) => {
    ...
    return <RenderGroupUpdateMemberManagerComponent useFormatName={useFormatName} useSelect={useSelect} selected={selected} useRemove={useRemove} useCreate={useCreate} useSearch={useSearch} search={search} {...props} />
}