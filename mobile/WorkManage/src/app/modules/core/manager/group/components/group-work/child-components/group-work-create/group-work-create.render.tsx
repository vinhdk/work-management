...
import { useStyles } from "./group-work-create.styles";
import { IGroupWorkCreateProps } from "./group-work-create.component";

export interface IRenderGroupWorkCreateProps extends IGroupWorkCreateProps {
...
export const RenderGroupWorkCreateComponent = (props: IRenderGroupWorkCreateProps) => (
    <ScrollView>
        ...
        <View style={useStyles().form}>
            ...
            <Item
                ...
                <Card style={{ width: "100%", borderColor: "black" }}>
                    ...
                    <CardItem>
                        <View style={{ flex: 1 }}>
                            {props.accounts.filter(e => e.Works.length === 0).length > 0 && <List
                                key="User"
                                dataArray={props.accounts.filter(e => e.Works.length === 0)}
                            ...
                            />}
                            {props.accounts.filter(e => e.Works.length === 0).length === 0 && <View>
