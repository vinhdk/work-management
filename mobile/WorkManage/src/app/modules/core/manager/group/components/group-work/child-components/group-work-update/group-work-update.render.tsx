...
import { IGroupWorkUpdateProps } from "./group-work-update.component";
import { UserVM } from "src/app/view-models";
import { useStyles } from "./group-work-update.styles";
import { ScrollView, TouchableOpacity } from "react-native-gesture-handler";
import { Image } from "react-native";
export interface IRenderGroupWorkUpdateProps extends IGroupWorkUpdateProps {
    ...
    extra: { solveBy: UserVM };
    fileUrl: string | undefined;
    done: boolean;
    inititalStatus: string;
}

export const RenderGroupWorkUpdateComponent = (props: IRenderGroupWorkUpdateProps) => (
    <ScrollView>
                ...
                <Card style={{ width: "100%", borderColor: "black" }}>
                    ...
                    <CardItem>
                        <View style={{ flex: 1 }}>
                            <List
                                key="User"
                                dataArray={[...props.accounts.filter(e => e.Works.length === 0), props.extra.solveBy]}
